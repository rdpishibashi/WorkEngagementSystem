...
const ColumnMaster2Direction6P90 = 27;         // stability_6 の直後（was not defined）
const ColumnMaster2Volatility6P90 = 28;        // stability_6 の直後（was not defined）
const ColumnMaster2InterventionPriorityNeg = 29; // was 27
const ColumnMaster2InterventionPriorityPos = 30; // was 28
const ColumnMaster2StrengthShort = 31;         // was 29
const ColumnMaster2WeaknessShort = 32;         // was 30
const ColumnMaster2StrengthMid = 33;           // was 31
const ColumnMaster2WeaknessMid = 34;           // was 32
const ColumnMaster2E_Delta1 = 35;              // was 33
const ColumnMaster2E_Delta1Prev = 36;          // was 34
const ColumnMaster2E_Delta1Std12 = 37;         // was 35
const ColumnMaster2E_Slope6 = 38;              // was 36
const ColumnMaster2E_Slope6Std12 = 39;         // was 37
const ColumnMaster2E_Slope3m = 40;             // was 38 (was also wrong: 44)
const ColumnMaster2V_Delta1 = 41;              // was 38 (was wrong)
const ColumnMaster2D_Delta1 = 42;              // was 39 (was wrong)
const ColumnMaster2A_Delta1 = 43;              // was 40 (was wrong)
const ColumnMaster2V_Slope6 = 44;              // was 41 (was wrong)
const ColumnMaster2D_Slope6 = 45;              // was 42 (was wrong)
const ColumnMaster2A_Slope6 = 46;              // was 43 (was wrong)
const ColumnMaster2FlagConstant6m = 47;        // was 45 (was wrong)
