...
const ColumnMasterDivision = 6;
const ColumnMasterCurrentDivision = 7;
const ColumnMasterDepartment = 8;
const ColumnMasterCurrentDepartment = 9;
const ColumnMasterSection = 10;
const ColumnMasterCurrentSection = 11;
const ColumnMasterTeam = 12;
const ColumnMasterCurrentTeam = 13;
const ColumnMasterProject = 14;
const ColumnMasterCurrentProject = 15;
const ColumnMasterGrade = 16;
const ColumnMasterFactor = 17;
const ColumnMasterRating = 18;
const ColumnMasterSlope6 = 19;
const ColumnMasterDelta1 = 20;
const ColumnMasterStrength = 21;
const ColumnMasterWeakness = 22;
const ColumnMasterTrendRefined = 23;

// Master2 sheet columns
const ColumnMaster2Date = 2;
const ColumnMaster2Address = 3;
const ColumnMaster2Name = 4;
const ColumnMaster2Division = 5;
const ColumnMaster2Department = 6;
const ColumnMaster2Section = 7;
const ColumnMaster2Team = 8;
const ColumnMaster2Project = 9;
const ColumnMaster2Grade = 10;
const ColumnMaster2Engagement = 11;
const ColumnMaster2Vigor = 12;
const ColumnMaster2Dedication = 13;
const ColumnMaster2Absorption = 14;
...
const ColumnCommentDivision = 6;
const ColumnCommentCurrentDivision = 7;
const ColumnCommentDepartment = 8;
const ColumnCommentCurrentDepartment = 9;
const ColumnCommentSection = 10;
const ColumnCommentCurrentSection = 11;
const ColumnCommentTeam = 12;
const ColumnCommentCurrentTeam = 13;
const ColumnCommentProject = 14;
const ColumnCommentCurrentProject = 15;
const ColumnCommentGrade = 16;
