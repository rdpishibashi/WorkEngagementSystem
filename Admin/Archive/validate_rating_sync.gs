...
function validateRatingSync(year = null, month = null, autoFix = false) {
  ...
  const fieldsToCompare = [
    ...
    { name: 'change_tag', ratingCol: ColumnRatingChangeTag },
    { name: 'stability', ratingCol: ColumnRatingStability },
    { name: 'E_delta_1', ratingCol: ColumnRatingE_Delta1 },
    { name: 'E_delta_1_prev', ratingCol: ColumnRatingE_Delta1Prev },
    { name: 'E_delta_1_std_6', ratingCol: ColumnRatingE_Delta1Std6 },
    { name: 'E_slope_6', ratingCol: ColumnRatingE_Slope6 },
    { name: 'E_slope_6_std_6', ratingCol: ColumnRatingE_Slope6Std6 },
...
/**
 * Validate and auto-fix a specific month
 */
function validateAndFix_2025_12() {
  return validateRatingSync(2025, 12, true);
}
